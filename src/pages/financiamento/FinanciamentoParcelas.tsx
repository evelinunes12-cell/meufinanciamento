...
const FinanciamentoParcelas = () => {
  ...
  const handleRecalcular = async () => {
    ...
    if (error) {
      toast({
        title: "Erro",
        description: "Erro ao recalcular parcelas",
        variant: "destructive",
      });
    } else {
      toast({
        title: "Sucesso",
        description: "Todas as parcelas foram resetadas",
      });
      fetchData();
    }
      ...
      <AppLayout>
        <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4">
          ...
          <p className="text-muted-foreground text-center max-w-md">
            Configure um financiamento primeiro para visualizar as parcelas.
          </p>
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle>Recalcular todas as parcelas?</AlertDialogTitle>
                  <AlertDialogDescription>
                    Isso irá resetar o status de pagamento de todas as parcelas. Esta ação não pode ser desfeita.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
        ...
        <Card className="shadow-card">
          <CardHeader>
            ...
            <CardDescription>
              Clique em uma parcela para registrar pagamento
            </CardDescription>
          </CardHeader>
